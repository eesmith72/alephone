...
#include "interface.hpp" // get_app_state
...
{
	lua_pushboolean(L, player_automap_visibility.has_line(Lua_Line::Index(L, 1)));
	return 1;
}
...
static int Lua_Line_Set_Visible_On_Automap(lua_State *L)
{
	...
	if (lua_toboolean(L, 2))
        player_automap_visibility.add_line(Lua_Line::Index(L, 1));
	else
        player_automap_visibility.remove_line(Lua_Line::Index(L, 1));
	return 0;
}
...
{
	lua_pushboolean(L, player_automap_visibility.has_polygon(Lua_Polygon::Index(L, 1)));
	return 1;
}
...
static int Lua_Polygon_Set_Visible_On_Automap(lua_State *L)
{
	...
	if (lua_toboolean(L, 2))
        player_automap_visibility.add_polygon(Lua_Polygon::Index(L, 1));
	else
        player_automap_visibility.remove_polygon(Lua_Polygon::Index(L, 1));
	return 0;
}
