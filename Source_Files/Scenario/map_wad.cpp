...
void process_map_wad(wad_data* wad, bool restoring_game, short version)
{
	...
	assert_fail_f(version==MARATHON_INFINITY_DATA_VERSION || version==MARATHON_TWO_DATA_VERSION || version==MARATHON_ONE_DATA_VERSION, "Map version: %d", version); // TODO: there should be one ingress point for ALL WADs and, again, ALWAYS check version there
