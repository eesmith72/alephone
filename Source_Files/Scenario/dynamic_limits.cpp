...
static void reallocate_dynamic_limits()
{
	...
	EffectList.resize(get_effects_limit());
	ObjectList.resize(get_objects_limit());
	MonsterList.resize(get_monsters_limit());
	ProjectileList.resize(get_projectiles_limit());
