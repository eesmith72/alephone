...
// Main routine
void RenderVisTreeClass::build_render_tree(camera_settings_t* View)
{
    view = View;
	assert_fail(view, "");	// Idiot-proofing // EES: the irony of this endlessly-repeating LP comment is not missed
