/*
 *  RenderRasterize_Shader.h -- this and Rasterizer_Shader render the 3D gameworld in OGL
...
public:
	...
	std::unique_ptr<TextureManager> setupWallTexture(const shape_descriptor& Texture, short transferMode,
                                                     float pulsate, float wobble, float intensity, float offset, RenderStep renderStep);
