...
{
    // TODO: in Modern, Far should always use Trilinear and Near should be None by default with ability to override this per-collection in Shapes MML as HD sprites may benefit slightly from smoothing (the original low-res sprites should never be smoothed as that looks appalling)
