/*
 OGL_FBO.h -- Framebuffer Object utilities
...
public:
	FBOSwapper(GLuint w, GLuint h, bool srgb = false) : first(w, h, srgb), second(w, h, srgb),
                                                        draw_to_first(true), active(false), clear_on_activate(true) {}
