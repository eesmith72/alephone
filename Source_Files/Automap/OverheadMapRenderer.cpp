...
{
    saved_automap_lines = AutomapLineList;
    saved_automap_polygons = AutomapPolygonList;
    clear_automap();
...
{
    if (!saved_automap_lines.empty()) // these tests may not be needed
	{
        AutomapLineList = saved_automap_lines;
        saved_automap_lines.clear();
	}
    if (!saved_automap_polygons.empty())
	{
        AutomapPolygonList = saved_automap_polygons;
        saved_automap_polygons.clear();
	}
}
