/*
 ReplacementSounds.h -- Handles MML-specified external replacement sounds
...
public:
	...
	std::shared_ptr<SoundData> LoadExternal(const ao_path& File);
};
...
{
public:
	static inline SoundReplacements* instance() // EES: TODO: hate this bloody singleton bullshit; just needless complexity
    {
...
private:
	...
	std::map<key, SoundOptions> m_hash;
};
